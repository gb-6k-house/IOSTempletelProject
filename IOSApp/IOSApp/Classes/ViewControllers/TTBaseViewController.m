...
-(void)configeRefreshTableView:(UITableView*)tableView headBlock:(MJRefreshComponentRefreshingBlock)headBlock footBlock:(MJRefreshComponentRefreshingBlock)footBlock{
    if (headBlock != nil) {
        tableView.mj_header = [MJRefreshNormalHeader headerWithRefreshingBlock:headBlock];
    }
    if (footBlock !=nil) {
        tableView.mj_footer = [MJRefreshBackNormalFooter footerWithRefreshingBlock:footBlock];
